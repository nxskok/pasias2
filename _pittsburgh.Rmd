...
[link](http://ritsokiguess.site/datafiles/bridges.csv) contains
...
```{r pittsburgh-1 }
my_url <- "http://ritsokiguess.site/datafiles/bridges.csv"
...
[link](http://ritsokiguess.site/datafiles/mm.csv).) Do not
