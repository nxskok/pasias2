...
A reminder that the `inherit.aes` is to tell `ggplot` not to take anything for the `geom_point` from the `plot_predictions` graph (which has additional things that it would be a pain to override).
