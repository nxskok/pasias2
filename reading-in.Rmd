...
```{r 02-reading-in-2, child="_packages.qmd"}
```


```{r 02-reading-in-3, child="_oj_qq.Rmd"}
```

```{r 02-reading-in-4, child="_soap_qq.Rmd"}
```

```{r 02-reading-in-5, child="_global_qq.Rmd"}
```


My solutions follow:

```{r 02-reading-in-6, child="_oj.Rmd"}
```

```{r 02-reading-in-7, child="_soap.Rmd"}
```

```{r 02-reading-in-8, child="_global.Rmd"}
```
