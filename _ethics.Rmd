...
file at
[link](https://ritsokiguess.site/datafiles/decision.csv). The
...
```{r ethics-1 }
my_url <- "https://ritsokiguess.site/datafiles/decision.csv"
...
```{r}
plot_predictions(decide.3, condition = c("relativism", "idealism"))
```
